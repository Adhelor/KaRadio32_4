 ...
 *  STATIC VARIABLES
 **********************/
static const int DUTY_MAX = 0xff;
...
static void backlight_init()
{
	...
	ledc_timer.duty_resolution = LEDC_TIMER_8_BIT; // set timer counter bit number
	ledc_timer.freq_hz = 7000;						// set frequency of pwm
...
void LedBacklightInit()
{
	...
	if (lcdb != GPIO_NONE)
	{
		ESP_LOGI(TAG, "Initializing LCD backlight on GPIO %d", lcdb);
