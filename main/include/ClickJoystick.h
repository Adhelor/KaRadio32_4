...
// ---Button defaults-------------------------------------------------------------
#define JOY_BUTTONINTERVAL    10  // check enc->button every x milliseconds, also debouce time
#define JOY_DOUBLECLICKTIME  600  // second click within 400ms
#define JOY_HOLDTIME        1000  // report held button after 1s
// ----------------------------------------------------------------------------
