...
// ---Button defaults-------------------------------------------------------------
#define IENC_BUTTONINTERVAL    10  // check enc->button every x milliseconds, also debouce time
#define IBTN_DOUBLECLICKTIME  600  // second click within 400ms
#define IBTN_HOLDTIME        1000  // report held button after 1s
