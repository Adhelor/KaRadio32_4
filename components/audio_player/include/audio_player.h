...
typedef enum
{
    MIME_UNKNOWN = 1, OCTET_STREAM, AUDIO_AAC, AUDIO_MP4, AUDIO_MPEG, AUDIO_OGG, AUDIO_BT_PCM, AUDIO_UNKNOWN
} content_type_t;
...
// Declare player_status as extern
extern component_status_t player_status;

// Declare the get_player_status function
