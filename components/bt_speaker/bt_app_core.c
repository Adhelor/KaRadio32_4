...
{
    bt_app_task_queue = xQueueCreate(16, sizeof(bt_app_msg_t));
    xTaskCreate(bt_app_task_handler, "BtAppT", 3328, NULL, configMAX_PRIORITIES - 2, &bt_app_task_handle); // #memchange 3584
    return;
}
